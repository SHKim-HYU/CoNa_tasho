...
def mpc_run():
    ...
    while True:
        ...
        # twist_d = [(vd_control_sig+dvd_control_sig*t_mpc)*np.cos(thd_control_sig), (vd_control_sig+dvd_control_sig*t_mpc)*np.sin(thd_control_sig),wd_control_sig+dwd_control_sig*t_mpc]
